...
>### Моля всички, регистрирайте се в git hub. Aко нямате достъп до задачите и не можете да се assigne-те задача - моля поискайте [Ilko Kacharov](https://github.com/kachar) да ви добави към Подкрепи.бг организацията в GitHub. 
